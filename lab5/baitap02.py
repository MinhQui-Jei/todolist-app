...
from PySide6.QtWidgets import QApplication, QFileSystemModel, QFileIconProvider, QScroller, QTreeView
...
if __name__ == "__main__":
    ...
    argument_parser.add_argument(
        "--no-custom", "-c", action="store_true",
        help="Set QFileSystemModel.DontUseCustomDirectoryIcons"
    )
    argument_parser.add_argument(
        "--no-watch", "-w", action="store_true",
